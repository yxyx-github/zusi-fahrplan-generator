...
fn test_generate_fahrplan_with_buchfahrplan() {
    let tmp_dir = TmpDirHelper::from("./tests/generate_fahrplan_with_buchfahrplan/input");
    ...
    tmp_dir.assert_with("./tests/generate_fahrplan_with_buchfahrplan/expected", true, |actual, expected| {
